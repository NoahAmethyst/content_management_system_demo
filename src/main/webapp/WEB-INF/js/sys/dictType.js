            ...
            options.columns = [
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        ...
                        actions.push(' <a class="btn btn-info btn-xs" href="javascript:void(0)"   onclick="vm.detail(\''+row.dictId+'\',\''+row.dictType+'\')"><i class="fa fa-list-ul"></i>列表</a>');
